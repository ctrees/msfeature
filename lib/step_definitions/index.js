...
function utility() {
  ...
  this.Given(/^msPageLoad "([^"]*)" is done$/,                                  Ext.Utility.waitForPace);
}

function custom() {
  this.When(/^I scroll to the element with id="([^"]*)"$/,                      Ext.Custom.scrolltoid);
  this.When(/^I scroll down "([^"]*)" pixels$/,                                 Ext.Custom.scrollDown);
  this.When(/^I scroll up "([^"]*)" pixels$/,                                   Ext.Custom.scrollUp);
}
